...
set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "/Zi /Ox /DNDEBUG")
if (FIPS_UWP)
    ...
    set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "${CMAKE_CXX_FLAGS_RELWITHDEBINFO} /MD /ZW")
else()
    ...
    set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "${CMAKE_CXX_FLAGS_RELWITHDEBINFO} ${FIPS_VS_CRT_FLAGS}")
endif()
...
set(CMAKE_C_FLAGS_RELWITHDEBINFO "/Zi /Ox /DNDEBUG ")
if (FIPS_UWP)
    # must link runtime as DLLs
    set(CMAKE_C_FLAGS_DEBUG "${CMAKE_C_FLAGS_DEBUG} /MDd /ZW")
    set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} /MD /ZW")
    set(CMAKE_C_FLAGS_RELWITHDEBINFO "${CMAKE_C_FLAGS_RELWITHDEBINFO} /MD /ZW")
else()
    ...
    set(CMAKE_C_FLAGS_RELWITHDEBINFO "${CMAKE_C_FLAGS_RELWITHDEBINFO} ${FIPS_VS_CRT_FLAGS}")
endif()
...
set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "${CMAKE_CXX_FLAGS_RELWITHDEBINFO}" CACHE STRING "C++ RelWithDebInfo Compiler Flags" FORCE)
...
set(CMAKE_C_FLAGS_RELWITHDEBINFO "${CMAKE_C_FLAGS_RELWITHDEBINFO}" CACHE STRING "C RelWithDebInfo Compiler Flags" FORCE)
...
set(CMAKE_EXE_LINKER_FLAGS_RELWITHDEBINFO "${CMAKE_EXE_LINKER_FLAGS_RELWITHDEBINFO}" CACHE STRING "RelWithDebInfo Linker Flags" FORCE)
